...
<body translate="no">
    ...
    <script id="rendered-js">
        ...
        function showTask() {
            // Make an AJAX request to fetch data from Laravel
            const xhr = new XMLHttpRequest();
            xhr.open('GET', '/todo/data', true);
            ...
            xhr.onload = function() {
                if (xhr.status >= 200 && xhr.status < 300) {
                    ...
                    list.innerHTML = responseData.data; // Adjust this based on your Laravel response structure
                    ...
                    // Assuming you have a UL element with id 'list-container'
                    const listContainer = document.getElementById('list-container');
                    listContainer.innerHTML = htmlString;
                } else {
                    console.error('Failed to fetch data from Laravel');
                }
            };

            xhr.onerror = function() {
                console.error('Network error while trying to fetch data from Laravel');
            };
